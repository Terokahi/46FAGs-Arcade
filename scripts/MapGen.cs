...
public partial class MapGen : Node2D
{
	...
	private TileMapLayer wall, floor, fluid;
	...
	/// Sets the fluid layer of the map
	/// <param name="node">The fluid layer of the map
	public void setFluid()
	{
		fluid = GetNode<TileMapLayer>("Fluid");
	}

	/// Getter Methods for the Layers
	public TileMapLayer getWall => wall;
	public TileMapLayer getFloor => floor;
	public TileMapLayer getFluid => fluid;
	...
	public override void _Ready()
	{
		...
		MapInit(new Vector2I(0,0), new Vector2I(width, height));
	}
	...
	private void MapInit(Vector2I pos, Vector2I size, type)
	{	
	...
	/*
	GD.Randomize()	
	roomAmount = random.RandiRange(1, 400)
	while roomAmount > 0
	{
		setArea(pos, size, TS_ID);
	} 
	*/
	...
	{	
		if wall.GetCellSourceId(pos) == TS_ID
		Vector2I SolidStone = new Vector2I(2,1);
		wall = getFloor;
		for (int x = pos.X -1; x < size.X; x++)
		{
